      ...
      <div class="clearfix">
        <div class='fl headL'>
          ...
          <div class="headInfoTip" >
            <p class="firstChild">Tencent 腾讯，可视化平台</p>
            <p class="lastChild">Administrators  |  数据-维护管理中心-业务服务</p>
          </div>
        </div>
        <div class="fr">
            ...
            <div class="sidePerformance">
              ...
              <bar-chart></bar-chart>
                ...
                <div class="performInfo">
                  <ul class="clearfix">
                    <li>
                      <p class="radioInfo"><em class=" user"></em>36</p>
                      <p>个人</p>
                    </li>
                    <li>
                      <p class="radioInfo"><em class="department"></em>18</p>
                      <p>部门</p>
                    </li>
                    <li>
                      <p class="radioInfo"><em class="company"></em>56</p>
                      <p>公司</p>
                    </li>
                  </ul>
                </div>
